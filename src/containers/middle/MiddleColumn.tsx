...
export const MiddleColumn: FC = () => {
  ...
  async function storeData(password: string) {
    const dataToEncrypt = {
      smth: 'LALALALA',
      watafak: [1, 2, 3, 12, 31, 23, 123, 1, 23, 123, 12, 31, 2345, 2345],
      products: [
        {
          'id': 1,
          'title': 'iPhone 9',
    ...
    saveEncryptSession(dataToEncrypt, '3025102307')
  }
  ...
  return (
    <div class="MiddleColumn">
      <div class="MiddleColumn-inner">
        ...
        <Button onClick={() => storeData('3025102307')}>SAVE</Button>
        <Button
          onClick={() => {
