...
const FIREBASE_ERRORS: FirebaseErrors = {
  ...
  uk: {
    'auth/invalid-verification-code': 'Наданий код верифікації недійсний.'
  },
  de: {
    'auth/invalid-verification-code': 'Der angegebene Verifizierungscode ist ungültig.'
  },
  pl: {
    'auth/invalid-verification-code': 'Podany kod weryfikacyjny jest nieprawidłowy.'
  }
}
...
export function throwFirebaseError(
  ...
  if (err instanceof FirebaseError) {
    const error = getFirebaseErrorMessage(err.code, lang)
